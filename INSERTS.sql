-- URL: https://github.com/ElderHenhique/Inser-o_dos_Dados.git
...
VALUES	('13683347610', 'Entregador', 'Paraguaio', 1.650), ('11465722321', 'Operador de Caixa', 'Brasileira', 1.870),
		('10221676213', 'Empacotador', 'Argentino', 1.212), ('01226726607', 'Estoquista', 'Argentino', 1.450),
		('00702029916', 'Operador de Caixa', 'Brasileira', 1.870), ('09219865515','Repositor', 'Peruano', 1.450),
        ('05018788109', 'Auxiliar Administrativo', 'Brasileira', 2.120), ('11726491202', 'Açougueiro', 'Brasileiro', 2.000),
		('12092213718', 'Confeiteira/Padeira', 'Brasileira', 1.900), ('10792255961', 'Gerente', 'Brasileira', 2.800);
        
INSERT INTO CLIENTE(cpf_pessoa, preferencia, cadastro, classe_social)
VALUES  ('13683347610', 'Sim', 'TEM', 'Classe B'), ('11465722321', 'Sim', 'NÃO TEM', 'Classe B'),
		('10221676213','Sim', 'TEM', 'Classe D'), ('01226726607', 'Sim', 'TEM', 'CLasse C'),
        ('00702029916', 'Não', 'TEM', 'Classe E'), ('09219865515', 'Não', 'NÃO TEM', 'Classe C'),
        ('05018788109', 'Sim', 'TEM', 'Classe D'), ('11726491202', 'Sim', 'TEM', 'Classe C'),
        ('12092213718', 'Não', 'TEM', 'Classe C'), ('10792255961', 'Não', 'NÃO TEM', 'Classe A');
...
INSERT INTO FORNECEDORES(cod_forn, nome, localizacao)
...
INSERT INTO ENTREGA(cpf_func, id_vendas, telefone, tempo_estimado, numero_da_entrega)
VALUES 	('13683347610', 0029, '5544984385294', '22 minutos', 010),('13683347610', 0034, '5544984918826', '30 minutos', 019),
		('13683347610', 0039, '55449841775829', '40 minutos', 045),('13683347610', 0046, '5544984291752', '15 minutos', 028),
        ('13683347610', 0047, '5544984092751', '1 hora', 080),('13683347610', 0051, '5544984221174', '20 minutos', 070),
        ('13683347610', 0055, '5544984175829', '45 minutos', 061),('13683347610', 0063, '5544984145723', '50 minutos', 090),
        ('13683347610', 0068, '5544984019345', '35 minutos', 092),('13683347610', 0070, '5544984427756', '25 minutos', 011);
